...
import 'package:lab_midterm/view/screens/registrationscreen.dart';
...
class _SellerScreenState extends State<SellerScreen> {
  ...
  Future<void> _gotoNewProduct() async {
    ...
    if (await _checkPermissionGetLoc()) {
      ...
      Fluttertoast.showToast(
          msg: "Please allow the application to access the location",
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM,
          timeInSecForIosWeb: 1,
          fontSize: 14.0);
...
//check permission,get location,get address return false if any problem.
  ...
  void _loadProducts() {
    ...
    http
        .get(
      Uri.parse(
          "${Config.SERVER}/newhomestay_raya/php/loadsellerproducts.php?userid=${widget.user.id}"),
    )
        .then((response) {
  ...
  void _deleteProduct(index) {
    try {
      http.post(
          Uri.parse("${Config.SERVER}/php/delete_product.php"),
          body: {
