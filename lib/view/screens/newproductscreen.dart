...
class _NewProductScreenState extends State<NewProductScreen> {
                ...
                child: Column(children: [
                  ...
                  TextFormField(
                      ...
                      validator: (val) => val!.isEmpty || (val.length < 2)
                          ? "Homestay name must be longer than 2"
                          : null,
                  ...
                  TextFormField(
                      ...
                      validator: (val) => val!.isEmpty || (val.length < 5)
                          ? "Homestay description must be longer than 5"
                          : null,
                      maxLines: 4,
                      keyboardType: TextInputType.text,
                      decoration: const InputDecoration(
  ...
  void _newProductDialog() {
    if (_image == null) {
      Fluttertoast.showToast(
          msg: "Take picture of your Homestay",
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text("Sure?", style: TextStyle()),
          actions: <Widget>[
            TextButton(
              child: const Text(
                "Yes",
  ...
  void insertProduct() {
    ...
    http.post(
        Uri.parse("${Config.SERVER}/php/insert_product.php"),
        body: {
